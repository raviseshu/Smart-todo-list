...
DATABASES = {
    'default': dj_database_url.config(
        default=os.getenv('postgresql://postgres.kxzskktcqlebpoxvsbxy:NjumoCkPSuoW8II7@aws-0-ap-south-1.pooler.supabase.com:5432/postgres', 'sqlite:///db.sqlite3'),
        conn_max_age=600,
    )
}
...
# Django REST Framework (optional: customize as needed)
REST_FRAMEWORK = {
